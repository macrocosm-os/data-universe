...
from dynamic_desirability.desirability_retrieval import datetime_to_timebucket, to_lookup
        ...
        self.sample_json = [
            {
                "id": "label_job_1",
                "weight": 2.5,
                "params": {"keyword": None, "platform": "reddit", "label": "technology"},
            },
            {
                "id": "keyword_job_1",
                "weight": 1.8,
            ...
            {"id": "label_job_2", "weight": 3.0, "params": {"keyword": None, "platform": "reddit", "label": "science"}},
        ]
