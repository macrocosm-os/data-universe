...
class TestDataDesirabilityLookupConversion(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_json = [
            ...
            },
            {
                "id": "label_job_2",
                "weight": 3.0,
                "params": {"keyword": None, "platform": "reddit", "label": "science"},
            },
        ]
    ...
    def test_json_to_lookup(self):
        ...
        self.assertEqual(
            lookup.distribution[DataSource.REDDIT].weight, DataSource.REDDIT.weight
        )
        ...
        self.assertEqual(
            ai_job.start_timebucket, self.now_timebucket
        )  # using timebucket instead of datetime
        self.assertEqual(
            ai_job.end_timebucket, self.future_timebucket
        )  # using timebucket instead of datetime
    ...
    def test_job_matching(self):
        ...
        reddit_jobs = primitive_lookup.find_matching_jobs(
            ...
            None,
            "technology",
            now_timebucket,  # Using time bucket ID directly
        )
        ...
        x_jobs_2 = primitive_lookup.find_matching_jobs(
            ...
            "ai",
            "ai_news",
            before_now_timebucket,  # Using time bucket ID directly
        )
    ...
    def test_default_scale_factor(self):
        ...
        self.assertEqual(
            default_reddit, 0.075
        )  # Updated to match DEFAULT_SCALE_FACTOR constant
