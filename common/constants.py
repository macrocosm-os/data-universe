...
MIN_EVALUATION_PERIOD = dt.timedelta(minutes=30) # shorter evaluation period for testnet
...
BYTE_ALLOWANCE_DATE = dt.datetime(2025, 5, 27, tzinfo=dt.timezone.utc)  # May 27, 2025 UTC
