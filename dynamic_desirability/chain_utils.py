...
def _sync_retrieve_metadata(netuid: int, hotkey: str, network: str = "finney"):
    ...
    try:
        ...
        metadata = bt.core.extrinsics.serving.get_metadata(fresh_subtensor, netuid, hotkey)
...
class ChainPreferenceStore:
    ...
    async def retrieve_preferences(self, hotkey: str) -> str | None:
    ...
    async def batch_retrieve_preferences(self, hotkeys: list[str], chunk_size: int = 5) -> dict[str, str | None]:
